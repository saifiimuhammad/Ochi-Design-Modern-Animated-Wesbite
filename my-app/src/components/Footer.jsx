...
function Footer() {
    return (
        <div className='flex gap-5 w-full h-screen p-20 pb-10 bg-zinc-900 font-["Oswald"]'>
            <div className="w-1/2 h-full flex flex-col justify-between">
                <div className="headings">
                    <h1 className='uppercase leading-none text-[7rem]'>Eye-</h1>
                    <h1 className='uppercase leading-none text-[7rem]'>Opening</h1>
                </div>
                <div className="ochi-logo">
                    <a className='w-32'>
            ...
            <div className="w-1/2 h-full">
                <h1 className='uppercase leading-none text-[7rem]'>presentations</h1>

                <div className="details w-full flex flex-col gap-y-5 mt-10 text-lg font-['Neue_Montreal']">
                    <div className="s-details w-full flex flex-col gap-y-5">
                        <h2>S:</h2>
                        <div className="flex flex-col">
                            {["Instagram", "Behance", "Facebook", "Linkedin"].map((item, index) => {
                                return <a key={index} href="/" className='underline'>{item}</a>
                            })}
                        </div>
                    </div>
                    <div className="l-details w-full flex flex-col gap-y-5">
                        <h2>L:</h2>
                        <div className="flex flex-col">
                    ...
                    <div className="e-details w-full flex flex-col gap-y-5">
                        <h2>E:</h2>
                        <div className="flex flex-col">
                            <a href="/" className="underline">hello@ochi.design</a>
                        </div>
                    </div>
                    <div className="w-full text-zinc-700">© ochi design 2024. Legal Terms</div>
                </div>
            </div>
